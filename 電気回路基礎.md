...
1. **Units Matter:** Always convert mA→A, kΩ→Ω before calculations
2. **Check Power Ratings:** Component power > calculated power
3. **Capacitors:** Opposite of resistors for series/parallel
4. **Time Constants:** Understand RC and RL charging/discharging
5. **Transistor Selection:** BJT for small signals, MOSFET for power
6. **Always draw the circuit** when solving problems
7. **Know voltage drops:** LED ~2V, BJT V_BE ~0.7V, Diode ~0.7V
